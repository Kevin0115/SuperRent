...
insert into customer values (0000000,9541328538,'Simonette Oleszkiewicz','7 Hazelcrest Court');
insert into customer values (0000001,9676249844,'Judah Rippen','447 Oakridge Plaza');
insert into customer values (0000002,1784171243,'Ephraim Anthon','806 Oriole Plaza');
insert into customer values (0000003,6348001182,'Gavrielle Belfit','34619 Jackson Plaza');
insert into customer values (0000004,1827915328,'Vanni Audsley','4771 Clyde Gallagher Court');
insert into customer values (0000005,2898683042,'Jeniece Napolione','78 Cottonwood Circle');
insert into customer values (0000006,8518410079,'Gerry Skedgell','1579 Summit Court');
insert into customer values (0000007,3487343955,'Jarred Saintpierre','769 American Park');
insert into customer values (0000008,8195730351,'Cherry Fulks','880 Iowa Way');
insert into customer values (0000009,7753439700,'Johnnie Jerwood','4098 Morning Way');
insert into customer values (0000010,1211420847,'Renado De Brett','835 David Road');
insert into customer values (0000011,4059058071,'Fern Bartalini','73 Ohio Crossing');
insert into customer values (0000012,4783456807,'Renado Fowlds','90 Fallview Plaza');
insert into customer values (0000013,9273666685,'Rivi Tyres','622 Valley Edge Drive');
insert into customer values (0000014,4355470141,'Clem Spino','6 Transport Trail');
insert into customer values (0000015,8646549733,'Clayson Berrigan','9875 Springs Way');
insert into customer values (0000016,5667267557,'Hansiain Stigger','37 Basil Hill');
insert into customer values (0000017,2379241567,'Ibrahim Goding','241 Pond Place');
insert into customer values (0000018,3013434956,'Harris Saller','8774 Norway Maple Hill');
insert into customer values (0000019,7757365180,'Olivette Vakhrushev','5 Paget Park');
insert into customer values (0000020,9594796563,'Tades Zaniolo','0729 Messerschmidt Center');
insert into customer values (0000021,3209080882,'Ilyssa Braz','018 Derek Junction');
insert into customer values (0000022,3421657450,'Hermon Caplen','8936 Wayridge Court');
insert into customer values (0000023,4323338858,'Llewellyn Faro','50813 Menomonie Alley');
insert into customer values (0000024,8611908388,'Avram Rosenthaler','87 Veith Alley');
insert into customer values (0000025,2415899453,'Britte Kas','9 Blackbird Avenue');
insert into customer values (0000026,3856771318,'Cornell Jermy','2823 Artisan Way');
insert into customer values (0000027,6958672178,'Danika Biskupski','510 Grover Trail');
insert into customer values (0000028,9652959722,'Chilton Ridge','587 Service Circle');
insert into customer values (0000029,5946500687,'Philomena Pardy','71419 Dryden Circle');
